...
drop table if exists diagram_pair_list;
drop table if exists diagram_data;
drop table if exists runs_list;
drop table if exists run;
drop table if exists experiment_data_type_header;
drop table if exists experiment_row_type;
drop table if exists exp_data_type_list;
drop table if exists exp_properties;
drop table if exists expdatatype_list;
...
drop table if exists diagram_pair;
